/*  bab.js
    Build All Books (bab) node script
    Builds all book HTML
...
function buildABook (bookID) {

    let bookData = require(path.join(__dirname, '..', '_resources', 'book-data', bookID, 'book.json'));
...
//    buildABook(allBooksArr[i]);
//}

buildABook(path.join(__dirname, '..', '_resources', 'book-data','vasytwo'));